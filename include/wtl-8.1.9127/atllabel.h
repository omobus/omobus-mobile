...
//
/////////////////////////////////////////////////////////////////////////////
// CLabel Version 1.5.1
// 
// choke off CString (Igor Artemov <igor@ak-obs.ru> 12/03/2002)
//
/////////////////////////////////////////////////////////////////////////////
// CLabel Version 1.5.2
// 
// Add _CSTRING_NS::CString (Igor Artemov <igor@ak-obs.ru> 12/03/2002)
//
/////////////////////////////////////////////////////////////////////////////
#ifndef __atllabel_14_03_2002_h__
#define __atllabel_14_03_2002_h__
...
public:
    ...
    m_lf_inited = false;
		...
		m_hwndBrush = ::CreateSolidBrush(GetSysColor(COLOR_WINDOW/*COLOR_3DFACE*/));
	}
...
# endif //_WIN32_WCE
	...
	// =============================================================================================
	virtual CLabel& SetText(const TCHAR *tcText)
	{
...
#ifdef __ATLSTR_H__
  virtual CLabel& SetText(const _CSTRING_NS::CString& strText)
	{
	...
	// =============================================================================================
	virtual CLabel& SetFontName(const TCHAR *tcFont, BYTE byCharSet = ANSI_CHARSET)
	{	
		m_lf.lfCharSet = byCharSet;
		_tcscpy(m_lf.lfFaceName, tcFont);
		ReconstructFont();
		UpdateSurface();
		return *this;
	}
#ifdef __ATLSTR_H__
  virtual CLabel& SetFontName(const _CSTRING_NS::CString& strFont, BYTE byCharSet = ANSI_CHARSET)
	{	
		m_lf.lfCharSet = byCharSet;
...
protected:
    ...
    RedrawWindow();
		...
		parent.UpdateWindow(); <== Падает в WM6.5*/
	}
    ...
    if( !m_lf_inited ) {
      ...
      if(font.m_hFont == NULL) {
        font = AtlGetStockFont(SYSTEM_FONT);
        sys_font = true;
      }
			if(font.m_hFont != NULL) {
...
/*
			TCHAR cValue[1024];
			GetWindowText(cValue, sizeof(cValue));
      ShellExecute(NULL,_T("open"),cValue,NULL,NULL,SW_SHOWNORMAL);
*/
		}
		else
		{
	...
	void Init()
	{
		...
		if(::GetClassName(m_hWnd, lpszBuffer, 8))
		{
			if(lstrcmpi(lpszBuffer, _T("static")) == 0)
			{
				...
				if(dwStyle == SS_ICON 
#ifndef _WIN32_WCE
            || dwStyle == SS_BLACKRECT || dwStyle == SS_GRAYRECT || 
...
#endif //__atllabel_14_03_2002_h__
