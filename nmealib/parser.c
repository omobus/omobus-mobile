...
static unsigned int __nmea_malloc_count = 0;
static unsigned int __nmea_free_count = 0;
...
void nmea_parser_destroy(nmeaPARSER *parser)
{
    ...
    memset(parser, 0, sizeof(nmeaPARSER));
    RETAILMSG(TRUE, (L"nmealib: malloc=%u, free=%u\n", __nmea_malloc_count, __nmea_free_count));
}
